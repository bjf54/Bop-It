...
void loop() 
{
  ...
  if (firstPlay == true)
  {
    ...
    u8x8.clear();
    u8x8.drawString(0,0,"Let's-a go!");
    delay(2500);
    digitalWrite(LED_SUCCESS_GREEN, HIGH);
    delay(1250);
    u8x8.clear();
  ...
  // Display the initial score and set the font size
  displayText(score);
  ...
  // Display "Your final score was XXX. Press the Start button to play again!"
  String str1 = "You lose! Your score was";
  String str2 = ". Press the Start button to try again!";
  String loseString = str1 + score + str2;
  u8x8.setCursor(0,0);
  u8x8.print(loseString);
